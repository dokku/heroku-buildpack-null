...
```
# via command
dokku buildpacks:set $APP https://github.com/dokku/heroku-buildpack-null

# via env var
dokku config:set $APP BUILDPACK_URL=https://github.com/dokku/heroku-buildpack-null

# via a .buildpacks file with the following contents
https://github.com/dokku/heroku-buildpack-null
```
